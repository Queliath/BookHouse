...
(function ($, window, document, undefined) {
    ...
    var bookId = document.querySelector(".rating").getAttribute("data-bookId");
    var userId = document.querySelector(".rating").getAttribute("data-userId");
    ...
    var methods = {
        ...
        applyRating: function (e) {
            ...
            request.open("get", "rating?value=" + rating + "&userId=" + userId + "&bookId=" + bookId);
            request.onreadystatechange = function () {
                if (request.readyState === 4) {
                    if (request.status === 200) {
                        ratingValue.innerHTML = request.responseText;
                    }
                }
            };
            request.send(null);
