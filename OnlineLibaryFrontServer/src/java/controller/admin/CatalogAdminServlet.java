 ...
 * @author Владислав
 */
@WebServlet(name = "CatalogAdminServlet", urlPatterns = {"/catalog_admin"})
public class CatalogAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/view/admin/catalog_admin.jsp").forward(request, response);
    }
